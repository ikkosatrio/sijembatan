...
@section('title')
TRANSAKSI ANDA KAMI BATALKAN - {{ucwords($config->name)}}
@endsection

@section('description')
	Transaksi Anda Telah Kami Batalkan
@endsection

@section('header')
	<b style="color:#EC3B3B">Mohon Maaf Transaksi Anda Telah Kami Batalkan berikut merupakan detailnya</b>
@endsection
											...
											<table border="0" cellpadding="0" cellspacing="0" width="210" style="max-width: 100%;">
												<tr>
													<td align="left" class="textContent">
														...
														<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:12px;margin-bottom:0;color:#FFF;line-height:135%;">Pembatalan Transaksi</div>
													</td>
												</tr>
											</table>
										</td>
												...
												<tbody><tr>
													<td valign="top" class="textContent">
														...
														<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
															Mohon Maaf Transaksi Anda Kami Batalkan Karena terdapat suatu kesalahan silahkan hubungi kami lebih lanjut untuk menindak lanjuti transaksi tersebut , 
														</div>
													</td>
												</tr>
											</tbody></table>
